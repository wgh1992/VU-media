...
You may set read_current_chat scroll_notches and scroll_delay_seconds yourself. Use larger scroll_notches, such as 18-30, when the user wants faster or bigger scrolling.
