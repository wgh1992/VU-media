...
If WeChat appears stuck on the same visible page after clicks, or the user says it is stuck/frozen/卡住/固定一页, call refresh_wechat_window before continuing.
